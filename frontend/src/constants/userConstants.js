...
export const EMPLOYEE_NAME_ID_DEPT_LIST_REQUEST =
  'EMPLOYEE_NAME_ID_DEPT_LIST_REQUEST'
export const EMPLOYEE_NAME_ID_DEPT_LIST_SUCCESS =
  'EMPLOYEE_NAME_ID_DEPT_LIST_SUCCESS'
export const EMPLOYEE_NAME_ID_DEPT_LIST_FAIL = 'EMPLOYEE_NAME_ID_DEPT_LIST_FAIL'
export const EMPLOYEE_NAME_ID_DEPT_LIST_RESET =
  'EMPLOYEE_NAME_ID_DEPT_LIST_RESET'
